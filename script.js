...
// Reset the score & player choice/computer choice
const resetAll = () => {
  playerScoreNumber = 0;
...
// Check results and increase the scores, update resultstext.
...
// Passing HTML player selection values, and styling icons
...
// on Startup, set initial values to 0
resetAll();
